...
export ZSH="/home/tholian/.oh-my-zsh"
...
__conda_setup="$('/home/tholian/build/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/tholian/build/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/tholian/build/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/tholian/build/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
